...
public class OrderController {
    ...
    public ResponseEntity<ControllerResponse> orderAccommodation(@RequestBody @Validated List<OrderAccommodationRequest> orderAccommodationRequestList,
    ...
    public ResponseEntity<ControllerResponse> checkBookDate(@RequestParam("accommodation_id") long id,
    ...
    public ResponseEntity<ControllerResponse> getUserOrderList(Pageable pageable,
                                                               @MemberAuth AuthContext authContext) {
